...
class MyHomePage extends GetWidget<TodosController> {
      ...
      child:
           Obx(() => ListView.builder(
                    ...
                    itemBuilder: (context, index)  {
                      ...
                      subtitle: Text(controller.todos.value[index].task  ?? "text"),
                      trailing: Checkbox(value: controller.todos.value[index].done,
  ...
  _openPopup(context) {
    Alert(
        ...
        buttons: [
          DialogButton(
            onPressed: () => controller.addTodo(titleController.text, taskController.text),
            child: Text(
              "Add",
